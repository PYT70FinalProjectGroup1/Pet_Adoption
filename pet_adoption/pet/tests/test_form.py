...
#         form_data = {
#             "description": "Grooming service for cats.",
#         }
...
#         service = form.save(commit=False, animal=self.animal)
#         self.assertEqual(service.description, "Grooming service for cats.")
#         self.assertEqual(service.animal, self.animal)
...
#         treatment = form.save(commit=False, animal=self.animal)
#         self.assertEqual(treatment.next_date.strftime("%Y-%m-%d"), "2023-09-15")
#         self.assertEqual(treatment.notes, "Regular check-up.")
#         self.assertEqual(treatment.animal, self.animal)