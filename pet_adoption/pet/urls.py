...
from .views import HomeView, AboutView, DonateView, AdoptedAnimalsView, AvailableServicesView, CreateServiceView, \
    AvailableTreatmentsView, CreateTreatmentView, FindCatsView, FindDogsView, FindOtherPetsView, FindAllView, \
    RegisterView, AnimalDetailView, CreateAdoptionView
