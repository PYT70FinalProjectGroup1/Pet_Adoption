...
urlpatterns = [
    ...
    path("services/create/<int:animal_id>/",CreateServiceView.as_view(),name="create_service"),
    path("treatments/<int:pk>/", AvailableTreatmentsView.as_view(), name="treatments"),
    path("treatments/create/<int:animal_id>/",CreateTreatmentView.as_view(),name="create_treatment"),
    ...
    path("adoption/<int:pk>/approve/", ApproveAdoptionView.as_view(), name="approve_adoption"),
    path("adoption/story/<int:adoption_pk>/add/", AddAdoptionStoryView.as_view(), name="add_adoption_story"),
