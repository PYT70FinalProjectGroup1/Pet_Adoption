...
from .views import HomeView, AboutView, DonateView, AdoptedAnimalsView, AvailableServicesView, CreateServiceView, AvailableTreatmentsView,\
    CreateTreatmentView, FindCatsView, FindDogsView, FindOtherPetsView, FindAllView,RegisterView, AnimalDetailView, QuestionView, AdoptionFormView
...
urlpatterns = [
    ...
    path("find/all_pets/animal_detail/<int:animal_id>/", AnimalDetailView.as_view(), name='animal_detail'),
    ...
    path('question_form/', QuestionView.as_view(), name='question_form'),
    path('application_list/', AdoptionFormView.as_view(), name='application_list')
]